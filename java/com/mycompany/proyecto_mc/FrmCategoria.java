...
public class FrmCategoria extends javax.swing.JFrame {
                    ...
                    .addGroup(infoLayout.createSequentialGroup()
                        ...
                        .addGroup(infoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(infoLayout.createSequentialGroup()
                                ...
                                .addComponent(Nombre_categoria, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(infoLayout.createSequentialGroup()
                        .addGap(77, 77, 77)
                        .addComponent(enviar)))
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        ...
        if (Nombre_categoria.getText().isEmpty()) {//1| tc
            JOptionPane.showMessageDialog(this, "El campo Nombre de categoría es requerido", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        // Validar que solo contenga letras
        if (!Nombre_categoria.getText().matches("[a-zA-Z]+")) {//2| tc
            JOptionPane.showMessageDialog(this, "El campo Nombre de categoría solo puede contener letras", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
//T= 2tc
        this.enviar();
